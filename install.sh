...
echo ""
echo "================================================================="
echo " IMPORTANT: Please log out and log back in (or reboot) for the   "
echo " KDE Plasma panels, settings, and shortcuts to fully apply.      "
echo "================================================================="
echo ""
echo "To sync this on your other machine:"
